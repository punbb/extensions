...
$lang_pun_pm = array(
	...
	'Not selected'			=> 'No message selected to delete.',
	'Too long message'		=> 'Message length %s bytes exceeds the limit of %s bytes.',
	'Sent'					=> 'Sent',
	'Read'					=> 'Read',
	...
	'Outbox full'			=> 'Outbox exceeded maximum capacity of %s messages. Please, delete old and unnecessary messages from the Outbox.',
	'Inbox almost full'		=> '<strong>Notice!</strong> Inbox about to reach the maximum capacity of %s messages. Please, delete old and unnecessary messages. Otherwise, you cannot receive new messages if the limit is reached.',
	'Inbox overflow'		=> '<strong>Warning!</strong> Inbox reached the maximum capacity of %s messages. You cannot receive new messages. Please, delete old and unnecessary messages.',
	'Outbox almost full'	=> '<strong>Notice!</strong> Outbox about to reach maximum capacity of %s messages. Please, delete old and unnecessary messages. Otherwise, you cannot send messages if the limit is reached.',
