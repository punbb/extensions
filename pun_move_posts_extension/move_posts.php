...
if (isset($_POST['move_posts']))
{
	...
	$forum_page['crumbs'] = array(
		...
		$multi ? $lang_pun_move_posts_extension['Move posts'] : $lang_pun_move_posts_extension['Move posts']);
            ...
            <form class="frm-form" method="post" accept-charset="utf-8" action="<?php echo $forum_page['form_action'] ?>">
                    ...
                    <fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
                                    ...
                                    <div class="sf-box select">
                                            <label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_pun_move_posts_extension['Destination topic']?></span></label><br />
