		...
		<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
			...
			<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
				<div class="sf-box text required">
					<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_pun_funny_avatars['Upload photo'] ?></span></label></br>
					<span class="fld-input"><input id="fld<?php echo $forum_page['fld_count'] ?>" name="req_file" type="file" size="40" /></span>
				</div>
			</div>
		</fieldset>
		<div class="frm-buttons">
			<span class="submit"><input type="submit" name="photo_upload" value="<?php echo $lang_pun_funny_avatars['Upload'] ?>" /></span>
		</div>
	</form>