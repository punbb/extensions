	...
	<form id="afocus" class="frm-form" method="post" accept-charset="utf-8" action="<?php echo $forum_page['form_handler']; ?>">
		...
		<div class="sf-set set1">
			<div class="sf-box text">
				<label for="fld1">
				<span><?php echo $lang_pun_stop_bots['Your answer']; ?></span>
				</label><br/>
				<span class="fld-input"><input type="text" value="" maxlength="255" size="50" name="pun_stop_bots_answer" id="fld1"/></span>
			</div>
		</div>
		<div class="frm-buttons">
			<span class="submit"><input name="pun_stop_bots_submit" value="<?php echo $lang_pun_stop_bots['Answer']; ?>" type="submit"></span>
		</div>
	</form>
</div>
